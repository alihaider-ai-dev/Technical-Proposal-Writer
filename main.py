...
scope_of_work = {
    "Our Understanding of the Scope of Work": {
        "questions": [
            ...
            {
                "2. How do the project's objectives align with the client's strategic goals?": "We need to mention the client's strategic goals that related to the project objectives, show them as table. First column is client's strategic goals, 2nd column is project objectives that related to client's strategic goals, 3rd column explains how projects objectives align/contribute to client's strategic goals"
            },
            {
                "3. How do the project's objectives align with Saudi Vision 2030?\n4. How do the project's objectives align with the programs of Saudi Vision 2030?": "- We need to mention the Saudi Vision 2030 goals that related to the project objectives, show them as table. First column is Saudi vision goals, 2nd column is project objectives that related to 2030 goals, 3rd column explains how projects objectives align/contribute to 2030 goals\n- We need to mention the programs of Saudi Vision 2030 that related to the project objectives, show them as table. First column is programs of Saudi Vision 2030, 2nd column is project objectives that related to programs of Saudi Vision 2030, 3rd column explains how projects objectives align/contribute to programs of Saudi Vision 2030"
            },
            {
                "5. How do the project's objectives align with the United Nations Sustainable Development Goals (SDGs)?": "- We need to mention the United Nations Sustainable Development Goals that related to the project objectives, show them as table. First column is United Nations Sustainable Development Goals,2nd column is project objectives that related to United Nations Sustainable Development Goals, 3rd column explains how projects objectives align/contribute to United Nations Sustainable Development Goals"
            },
        ]
    },
    "Our understanding in project field or industry": {
        "questions": [
            ...
            {
                "3. What is the current state of the industry or field relevant to the project?": "- Give some state about the following in a Table: market size – targeted segments (which also explains the percentage of the population/seekers being considered/Instrested or tragetted ) – any other relevant state - ..."
            },
            {
                "4. What global and local information and statistics are available concerning the scope of the project (target group, efforts made, etc.)?": "- Must provide the updated and reliable reference urls/sources/citations and web links"
            },
            {
                "5. What are the global and regional best practices (global and regional experiences) similar or relevant to the project?": "In the answer, mention the practice name, organization name, country, brief about the practice, goals, programs and services, achievements, and impact in numbers.) it could be shown as two tables (1 table for global , 1 table for regional."
            },
            {
                "6. What are the local best practices (local experiences) similar or relevant to the project?": "- Max 03: In the answer, mention the practice name, country, brief about the practice, goals, programs and services, achievements, and impact in numbers.)(Must provide the updated and reliable reference urls/sources/citations and web links)"
            },
        ]
    },
    "Operational Model": {
